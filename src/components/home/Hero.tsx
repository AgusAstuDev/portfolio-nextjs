...
export default function Hero() {
  ...
  return (
    <section className="w-full h-screen flex flex-col justify-center items-center gap-[10px] md:gap-[20px] px-[20px]">
      <div className="w-full h-auto flex flex-col justify-center items-center gap-[20px]">
        ...
        >
          Desarrollador web <br /> Estudiante de Ing. en Sistemas
        </h3>
        <p
          ref={descRef}
        ...
        >
          Más de 2 años de experiencia desarrollando y priorizando la
